...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if RANK in [-1, 0]:
            ...
            with open(save_dir / "train_log.txt", "a") as results_log:
                results_log.write(
                    'epoch {}/{}  p:{}  r:{}  mAP:{}'.format(
                        epoch,
                        epochs - 1,
                        round(results[0], 6),
                        round(results[1], 6),
                    ...
                    + ((' *resume' if resume else ' *base') if epoch == start_epoch and start_epoch > 0 else '')
                    + (' *best' if best_fitness == fi else ' ')
                    + (f' time {(time.time() - t0) / 3600:.3f} hour.\n')
                )
